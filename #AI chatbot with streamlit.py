...
class ConversationManager:
    def __init__(self,api_key = None,base_URL = None , model = None , history_file = None , temperature = None , max_tokens = None , token_budget = None):
        ...
        self.system_messages = {
            "sassy_assistant": "You are a sassy assistand that is fed up by answering so many questions"

            "angry_assistant" : "You are an angry assistant taht likes yelling in all caps"
            
            "thoughtful_assistant":"You are a thoughtful assistant, you ask calrifying questions to ensure understanding and give solutions"
            
            "custom": "enter your custom system message here"
        }
        
        self.system_message = self.system_messages['sassy assistant'] #default person
        self.conversation_history = [{'role': 'system','content':self.system_messages}]
    ...
    def total_tokens_used(self):
        try:
            ...
            print(f'An unexcpected error has occured while calculating the total tokens used :{e}')
            return None
    ...
    def enforce_token_budget(self):
        try:
            ...
            print(f'An unexpected error has occured while enforcing the token budget {e}')
    ...
    def update_system_message_history(self):
        try:
            ...
            print(f'An unexpected error has occured while updating the system message in the conversation history :{e}')
    ...
    def chat_completion(self,prompt,temperature = None,max_tokens = None, model = None):
        ...
        try:
            ...
            print(f"An error has occured while geberating a response {e}")
            return None
...
#Initializing the conversation manager object
